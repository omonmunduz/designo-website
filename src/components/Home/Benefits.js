    ...
    <Wrapper>
      ...
      <Container>
        ...
        <Title>Resourceful</Title>
         <p>Everything that we do has a strategic purpose. We use an
        agile approach in all of our projects and value customer collaboration.
        It guarantees superior results that fulfill our clients’ needs.</p>
        </TextWrapper>
      </Container>
      <Container>
