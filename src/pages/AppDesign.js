...
const AppDesign = () => {
    const [showcases] = useState([
        {id:1, title:'Airfilter', text:'Solving the problem of poor indoor air quality by filtering the air', bg: airImg},
        {id:2, title:'Eyecam', text:' Product that lets you edit your favorite photos and videos at any time', bg: eyeCamImg},
        {id:3, title:'Faceit', text: 'Get to meet your favorite internet superstar with the faceit app', bg: faceImg},
        {id:4, title:'Todo', text: 'A todo app that features cloud sync with light and dark mode', bg: todoImg},
        {id:5, title:'Loopstudios', text: 'A VR experience app made for Loopstudios', bg: loopImg},
      ]);
    return <>
        <HeroTitleContainer>
            <HeroTextWrapper>
