...
const WebDesign = () => {
  const [showcases] = useState([
    {id:1, title:'EXPRESS', text:'A multi-carrier shipping website for ecommerce businesses', bg: expressImg},
    {id:2, title:'TRANSFER', text:'  Site for low-cost money transfers and sending money within seconds', bg: transferImg},
    {id:3, title:'PHOTON', text: 'A state-of-the-art music player with high-resolution audio and DSP effects', bg: photonImg},
    {id:4, title:'BUILDER', text: 'Connects users with local contractors based on their location', bg: builderImg},
    {id:5, title:'BLOGR', text: 'Blogr is a platform for creating an online blog or publication', bg: blogrImg},
    {id:6, title:'CAMP', text: ' Get expert training in coding, data, design, and digital marketing', bg: campImg},
  ]);
  return <>
    <HeroTitleContainer>
      <HeroTextWrapper>
